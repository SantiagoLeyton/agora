...
const teacherNav: NavItem[] = [
  ...
  { title: "Calificaciones", href: "/teacher/grades", icon: "NotebookPen", roles: ["teacher"], section: "Evaluación clínica" },
...
const adminNav: NavItem[] = [
  ...
  { title: "Calificaciones", href: "/admin/grades", icon: "NotebookPen", roles: ["admin"], section: "Academia" },
